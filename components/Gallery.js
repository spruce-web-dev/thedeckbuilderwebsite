class SiteGallery extends HTMLElement {
    connectedCallback() {
        ...
        if (filterAttr === "none") {
            ...
            filtersToRender = Object.keys(FILTER_MAP);
        } else {
            filtersToRender = filterAttr.split(",").map(f => f.trim());
        }
        ...
        const filterButtonsHTML = filtersToRender.map((key, i) => {
            ...
            return `
                <button 
                    onclick="displayGallery('${f.value}', '${f.label}')"
            ...
            <section id="gallery" class="section bg-white">
                <div class="container">
                    ...
                    <div class="gallery-load-more">
                        <button id="loadMoreBtn" class="btn-primary" onclick="renderMoreGallery()" style="display:none;">
                            Load More
                        </button>
                    </div>
                </div>
        ...
        // Initialize gallery with first filter (if exists)
